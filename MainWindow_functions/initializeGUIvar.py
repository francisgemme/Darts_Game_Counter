...
def initializeGUIvar(MainWindow):
    ...
    MainWindow.p1_DoubleInVar = [] # Selected Game Mode
    MainWindow.p2_DoubleInVar = [] # Selected Game Mode
    MainWindow.p3_DoubleInVar = [] # Selected Game Mode
    MainWindow.p4_DoubleInVar = [] # Selected Game Mode
